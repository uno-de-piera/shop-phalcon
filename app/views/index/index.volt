<div class="row">
    ...
    <div class="col-md-4">
    	<ul class="nav nav-pills">
            <li>
            	<a href="<?php echo $this->url->get("") ?>" class="list-group-item active">Mascotas</a>
            </li>
            <li>
        ...
        <?php
        	...
        	?>
        		<tr>
	        		...
	        		<td>
	        			<a href="<?php echo $this->url->get("index/remove/".$content['rowId'])."/pets" ?>" class="btn btn-danger btn-xs">
        ...
        <a href="<?php echo $this->url->get("index/removeCart/pets") ?>" 
    ...
    <div class="col-md-8">
        ...
        ?>
            <div class="col-sm-4 col-lg-4 col-md-4">
                <div class="thumbnail">
                    <img src="<?php echo $this->url->get("img/mascotas.jpg") ?>" alt="">
                    <div class="caption">
                        ...
                        <?php echo $this->tag->form(array("index/add", "method" => "post")) ?>
	                		...
	                		<input type="hidden" name="cartName" value="pets">
