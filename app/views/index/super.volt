<div class="row">
    ...
    <div class="col-md-4">
    	<ul class="nav nav-pills">
            ...
            <li>
                <a href="<?php echo $this->url->get("index/perfumes") ?>" class="list-group-item">Perfumes</a>
            </li>
            <li>
                <a href="<?php echo $this->url->get("index/super") ?>" class="list-group-item active">Supermercado</a>
            </li>
        </ul>
        <hr>
        <div class="clear-fix"></div>
        ...
        <?php
        	...
        	?>
        		<tr>
	        		...
	        		<td>
	        			<a href="<?php echo $this->url->get("index/remove/".$content['rowId'])."/super" ?>" class="btn btn-danger btn-xs">
        ...
        <a href="<?php echo $this->url->get("index/removeCart/super") ?>" 
    ...
    <div class="col-md-8">
        ...
        ?>
            <div class="col-sm-4 col-lg-4 col-md-4">
                <div class="thumbnail">
                    <img src="<?php echo $this->url->get("img/super.jpg") ?>" alt="">
                    <div class="caption">
                        ...
                        <?php echo $this->tag->form(array("index/add", "method" => "post")) ?>
	                		...
	                		<input type="hidden" name="cartName" value="super">
